...
(function () {
  ...
  for (r = 0; r < 256; ++r)
    (A = r.toString(16)),
      r < 16 && (A = "0" + A),
      (C[A] = C[A.toUpperCase()] = r.toString() + ",");
  function n(a) {
  ...
  function az(g, j, l, m, f) {
    var a,
      ...
      h = 2 / g,
      i;
    i = Math.PI * (3 - B(5) + (parseFloat(f) ? parseFloat(f) : 0));
    for (a = 0; a < g; ++a)
      (b = a * h - 1 + h / 2),
        (c = B(1 - b * b)),
        (d = a * i),
        e.push([k(d) * c * j, b * l, o(d) * c * m]);
    return e;
  }
  function W(n, p, m, l, h, g) {
    var b,
      f = [],
      i = 2 / n,
      j,
      ...
      c,
      e;
    j = Math.PI * (3 - B(5) + (parseFloat(g) ? parseFloat(g) : 0));
    for (a = 0; a < n; ++a)
      (d = a * i - 1 + i / 2),
        (b = a * j),
        (c = k(b)),
        (e = o(b)),
        f.push(p ? [d * m, c * l, e * h] : [c * m, d * l, e * h]);
    return f;
  }
  function aa(l, e, f, h, i, j) {
    var b,
      g = [],
      m = (Math.PI * 2) / e,
      a,
    ...
    for (a = 0; a < e; ++a)
      (b = a * m),
        (c = k(b)),
        (d = o(b)),
        g.push(l ? [j * f, c * h, d * i] : [c * f, j * h, d * i]);
    return g;
  }
  function ay(a, b, c, d, e) {
    return W(a, 0, b, c, d, e);
  }
  function aF(a, b, c, d, e) {
    return W(a, 1, b, c, d, e);
  }
  function aE(b, c, d, e, a) {
    return (a = isNaN(a) ? 0 : a * 1), aa(0, b, c, d, e, a);
  }
  function av(b, c, d, e, a) {
  ...
  function L(a, m, j) {
    ...
    if (a.gCanvas) (f = a.gCanvas.getContext("2d")), (d = a.gCanvas.height);
      ...
      if ((D(e[0]) ? (d = e.length) : (e = [e]), (a.gCanvas = i = l(k, d)), !i))
        return null;
      f = i.getContext("2d");
      for (b = 0; b < d; ++b) aB(f, k, b, e[b]);
    }
    return (
      (j = g(h(j || 0, d - 1), 0)),
      (c = f.getImageData(~~((k - 1) * m), j, 1, 1).data),
      "rgba(" + c[0] + "," + c[1] + "," + c[2] + "," + c[3] / 255 + ")"
    );
  }
  function _(b, i, q, k, o, n, h, d, a, g, f, l) {
      ...
      return (
        ...
        !o
          ...
          : ((k = i = b / 2),
            ...
            (y = h(E, s / 2, u / 2)),
            (a = o.getContext("2d")),
            D && ((a.fillStyle = D), v(a, k, i, s, u, y)),
            b &&
              ((a.strokeStyle = F), (a.lineWidth = b), v(a, k, i, s, u, y, !0)),
            (m || B || C) &&
              ((t = l(e, f)), t && ((z = a), (a = t.getContext("2d")))),
            _(
              a,
              this.font,
              G,
  ...
  function ab(n, u, t, e, s, c, w, d, r, x) {
    var g = u + (2 * d + c) * e,
      f = t + (2 * d + c) * e,
      k = l(g, f),
      b,
    ...
    return k
      ? ((c *= e),
        ...
        (b = k.getContext("2d")),
        (p = h(r, m / 2, j / 2)),
        s && ((b.fillStyle = s), v(b, i, q, m, j, p)),
        c && ((b.strokeStyle = w), (b.lineWidth = c), v(b, i, q, m, j, p, !0)),
        x
          ? ((o = l(g, f)),
            (a = o.getContext("2d")),
        ...
        : (f.indexOf("%") > 0 ? (b = (i * b) / 100) : (b = b * j),
          ...
          b >= i / 2
            ? ((b = h(c, d) / 2),
              ...
              a.fill(),
              a.closePath())
            : ((b = h(c / 2, d / 2, b)), v(a, 0, 0, c, d, b, !0), a.fill()),
          (a.globalCompositeOperation = "source-in"),
          a.drawImage(k, 0, 0, c, d),
          e)
    );
  }
  function am(q, m, i, b, h, a, c) {
    var g = p(c[0]),
      f = p(c[1]),
      j = m + (g > a ? g + a : a * 2) * b,
      k = i + (f > a ? f + a : a * 2) * b,
  ...
  function ae(m, o, k) {
    ...
    (g = j.getContext("2d")),
      (g.fillStyle = "#000"),
      g.fillRect(0, 0, c, h),
      _(g, k + "px " + o, "#fff", m, 0, 0, 0, 0, [], "centre"),
    ...
    (f.width = f.width),
      ...
      b.txtOpt &&
        ...
        e < f.naturalWidth || d < f.naturalHeight
          ? ((c = R(h, e, d)), c && (a.fimage = c))
          : ((e = a.iw), (d = a.ih), (g = 1)),
        parseFloat(b.imageRadius) &&
          (a.image = a.fimage = h = at(a.image, b.imageRadius, e, d, g)),
        a.HasText() ||
          (b.shadow &&
            ((c = am(a.image, e, d, g, b.shadow, b.shadowBlur, b.shadowOffset)),
  ...
  function ap(b) {
    var e = a,
      f = d.addEventListener ? 0 : 1,
      c = u(b);
    c && b.button == f && e.tc[c] && e.tc[c].BeginDrag(b);
  }
  function aq(b) {
    var f = a,
      g = d.addEventListener ? 0 : 1,
      e = u(b),
      c;
    e &&
      b.button == g &&
      f.tc[e] &&
      ((c = f.tc[e]), ah(b), !c.EndDrag() && !c.touchState && c.Clicked(b));
  }
  function ar(c) {
    var e = u(c),
      b = e && a.tc[e],
  ...
  function X(f) {
    var g = d.getElementById(f),
      ...
      j = a.clientLeft || c.clientLeft,
      k = a.clientTop || c.clientTop;
  ...
  (f = V.prototype),
    ...
    (f.DrawColourImage = function (a, q, p, o, n, m, i, r, k) {
      var f = a.canvas,
        e = ~~g(q, 0),
        d = ~~g(p, 0),
        ...
        j;
      return (
        t ? ((t.width = c), (t.height = b)) : (t = l(c, b)),
        !t
          ? this.SetMethod("outline")
          : ((j = t.getContext("2d")),
            j.drawImage(f, e, d, c, b, 0, 0, c, b),
            a.clearRect(e, d, c, b),
            this.pulsate ? (i.alpha = 1 - x(this.pulse, 2)) : (i.alpha = 1),
            i.Draw(a, r, k),
            a.setTransform(1, 0, 0, 1, 0, 0),
            a.save(),
            a.beginPath(),
    ...
    (f.DrawPulsate = function (h, d, e, f) {
      var g = q() - this.ts,
        ...
        b =
          c.pulsateTo +
          (1 - c.pulsateTo) *
            (0.5 + k((2 * Math.PI * g) / (1e3 * c.pulsateTime)) / 2);
      return (
    ...
    (f.PreDraw = f.PostDraw = f.LastDraw = w);
  function I(a, h, c, b, e, f, g, d, i, j, k, l, m, n) {
    (this.tc = a),
      (this.image = null),
      (this.text = h),
  ...
  (c = I.prototype),
    ...
    (c.SetImage = function (a) {
      this.image = this.fimage = a;
    }),
    (c.SetAudio = function (a) {
      (this.audio = a), this.audio.load();
    }),
    (c.SetDraw = function (a) {
      (this.Draw = this.fimage
        ? a.ie > 7
          ? this.DrawImageIE
          : this.DrawImage
        : this.DrawText),
        a.noSelect && (this.CheckActive = w);
    }),
    (c.MeasureText = function (d) {
      var a,
        e = this.text.length,
        b = 0,
        c;
    ...
    (c.Weight = function (b, i, a, d, f, h, e) {
      b = isNaN(b) ? 1 : b;
      var c = (b - f) / (h - f);
      "colour" == d
        ? (this.colour = L(a, c, e))
    ...
    (c.SetShadowColourFixed = function (a, b, c) {
      a.shadowColor = b;
    }),
    (c.SetShadowColourAlpha = function (a, b, c) {
      a.shadowColor = aG(b, c);
    }),
    (c.DrawText = function (a, h, i) {
      var e = this.tc,
        g = this.x,
        f = this.y,
        c = this.sc,
    ...
    (c.Calc = function (g, e) {
      ...
      return (
        ...
        (this.xformed = a),
        (a = aA(b, a, b.stretchX, b.stretchY)),
        (this.x = a.x),
        (this.y = a.y),
        (this.z = a.z),
        (this.sc = a.w),
    ...
    (c.CheckActive = function (a, d, e) {
      var b = this.tc,
        c = this.UpdateActive(a, d, e);
      return c.Active(a, b.mx, b.my) ? c : null;
    }),
    (c.Clicked = function (f) {
      var b = this.a,
        a = b.target,
        c = b.href,
        e;
      if (a != "" && a != "_self") {
        if (self.frames[a]) self.frames[a].document.location = c;
        else {
          try {
            if (top.frames[a]) {
              top.frames[a].document.location = c;
              return;
            }
          } catch (a) {}
          window.open(c, a);
    ...
    (c.StopAudio = function () {
      this.audio && this.playing && this.audio.pause(),
        (this.stopped = 1),
        (this.playing = 0);
    }),
    (c.PlayAudio = function () {
  ...
  function a(f, o, k) {
    ...
    if (
      ...
      for (c = 0; c < l.length; ++c) i[l[c]] = b[l[c]];
      throw (b.parentNode.insertBefore(i, b), b.parentNode.removeChild(b), 0);
    }
    for (c in a.options)
      this[c] = k && n(k[c]) ? k[c] : n(a[c]) ? a[c] : a.options[c];
    if (
      ((this.canvas = b),
      ...
      (this.max_weight = []),
      (this.min_weight = []),
      (this.textFont = this.textFont && P(this.textFont)),
      (this.textHeight *= 1),
      ...
      this.minTags > 0 &&
        this.repeatTags < 1 &&
        (c = this.GetTags().length) &&
        (this.repeatTags = ad(this.minTags / c) - 1),
      (this.transform = m.Identity()),
      (this.startTime = this.time = q()),
      (this.mx = this.my = -1),
      this.centreImage && aD(this),
        ...
        ? ((this.ctitle = b.title),
          ...
          this.tooltip == "native"
            ...
            : ((this.Tooltip = this.TooltipDiv),
              this.ttdiv ||
                ((this.ttdiv = d.createElement("div")),
      ...
      (j[f] = [
        ...
        this.dragControl &&
          (j[f].push(["mousedown", ap]), j[f].push(["selectstart", w])),
        this.wheelZoom &&
          (j[f].push(["mousewheel", $]), j[f].push(["DOMMouseScroll", $])),
        this.scrollPause && j[f].push(["scroll", al, window]);
      for (c = 0; c < j[f].length; ++c)
        (i = j[f][c]), z(i[0], i[1], i[2] ? i[2] : b);
    }
    a.started ||
      ...
      (a.NextFrame = p ? a.NextFrameRAF : a.NextFrameTimeout),
  ...
  (b = a.prototype),
    (b.SourceElements = function () {
      return d.querySelectorAll
        ? d.querySelectorAll("#" + this.source)
        : [d.getElementById(this.source)];
    }),
    (b.HideTags = function () {
    ...
    (b.CreateTag = function (b) {
      ...
      if (
        ("image" != this.imageMode &&
          ...
          d.Empty()
            ? (d = null)
            : ((g = this.textFont || P(i(b, "font-family"))),
              this.splitWidth &&
                (f = d.SplitWidth(
                  this.splitWidth,
                  this.ctxt,
        ...
        return (
          ...
          c ? (a.SetImage(c), F(c, e[0], a, this)) : a.Init(),
          this.AddAudio(b, a),
          a
        );
    }),
    (b.UpdateTag = function (a, b) {
      var c = this.textColour || i(b, "color"),
        d = this.textFont || P(i(b, "font-family")),
    ...
    (b.Weight = function (d) {
      ...
      for (b = 0; b < f; ++b) {
        e[b] = [];
        for (a = 0; a < i; ++a)
          (c = ak(d[b].a, h[a], this.textHeight)),
    ...
    (b.Load = function () {
      var c = this.GetTags(),
        ...
        a,
        e = [],
        m = { sphere: az, vcylinder: ay, hcylinder: aF, vring: aE, hring: av };
      if (c.length) {
        e.length = c.length;
        for (a = 0; a < c.length; ++a) e[a] = a;
        this.shuffleTags && U(e),
          (h = 100 * this.radiusX),
          (i = 100 * this.radiusY),
          (j = 100 * this.radiusZ),
    ...
    (b.Update = function () {
      ...
      if (e.length) {
        ...
        for (b = d.length / (f.length + 1), a = 0; f.length; )
          d.splice(ad(++a * b), 0, this.CreateTag(e[f.shift()]));
    ...
    (b.LoadAudio = function () {
      if (!e && !ag()) return;
      (this.audio = d.createElement("audio")),
        ...
        (this.hasAudio = 1),
        (Q = function (a) {
          e.resume(), d.removeEventListener("click", Q);
        }),
    ...
    (b.ShowAudioIcon = function () {
      ...
      b || (b = e.state === l),
        this.audioIcon &&
          this.hasAudio &&
          (Z(b, d, a, k, f, g + 1, j ? i : h), Z(b, d, a, k, f, g, j ? h : i));
    }),
  ...
  function af(a) {
    var b = a.targetTouches[0],
      c = a.targetTouches[1];
    return B(x(c.pageX - b.pageX, 2) + x(c.pageY - b.pageY, 2));
  }
  (b.BeginPinch = function (a) {
    (this.pinched = [af(a), this.zoom]), a.preventDefault && a.preventDefault();
  }),
    (b.Pinch = function (d) {
      var b,
        c,
    ...
    (b.FindTag = function (a) {
      if (!n(a)) return null;
      if ((n(a.index) && (a = a.index), !D(a))) return this.taglist[a];
      var c, d, b;
      n(a.id)
        ? ((c = "id"), (d = a.id))
  ...
  (a.Linear = function (a, b) {
    ...
    (a.SetSpeed = function (c, b) {
      return (
        !!(D(b) && a.tc[c] && !isNaN(b[0]) && !isNaN(b[1])) &&
        (a.tc[c].SetSpeed(b), !0)
      );
    }),
    (a.TagToFront = function (c, b) {
      return !!D(b) && ((b.lat = b.lng = 0), a.RotateTag(c, b));
    }),
    ...
    (a.Delete = function (b) {
      var c, e;
      if (j[b])
        if (((e = d.getElementById(b)), e))
          for (c = 0; c < j[b].length; ++c) aj(j[b][c][0], j[b][c][1], e);
